...
public class ShowRoute extends AppCompatActivity {
    ...
    GoogleMap googleMap;
    Animation slide_up, slide_down,move_in;
    Double fromLat, toLat, fromLng, toLng;
    Marker tempMarker;
    boolean playIcon=true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment fragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.ShowRouteMap);
        ...
        toLayout.startAnimation(slide_up);

        fromLayout.setVisibility(View.VISIBLE);
        fromLayout.startAnimation(slide_down);
...
/*        cameraPosition=new CameraPosition.Builder()
        ...
        animateRoute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(playIcon) {
                    animateRoute.setImageResource(android.R.drawable.ic_media_play);
                    if (numOfWaypoints == 0)
                        showPath(allPoints, Routing.TravelMode.DRIVING, false, 0);
                    else
                    ...
                    animateRoute.setImageResource(android.R.drawable.ic_media_pause);
                    if (numOfWaypoints == 0)
